...
1. Press the "Use template" button at the top of this repo to create a new repo with the contents of this actions
...
[<img src="https://github-ads.s3.eu-central-1.amazonaws.com/actions.jpg?t=1" width="419px" />](https://spatie.be/github-ad-click/actions)
...
```bash
php artisan vendor:publish --tag="actions_without_prefix-migrations"
php artisan migrate
```

You can publish the config file with:
```bash
php artisan vendor:publish --tag="actions_without_prefix-config"
```
...
```php
$actions = new DefStudio\Actions();
echo $actions->echoPhrase('Hello, DefStudio!');
```
